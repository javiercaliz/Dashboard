  ...
  function (MessageToast, Controller, JSONModel) {
    ...
    return Controller.extend("sap.f.Dashboard.controller.AgeController", {
      ...
      crearGrafico: function (arraySegmentacion) {
        ...
        const arrayPorcentajes = arraySegmentacion.map((x) =>
          Math.round((x * 100) / total)
        );
        const height = document.getElementById("__card1").offsetHeight * 0.95;
        const width = document.getElementById("__card1").offsetWidth * 0.95;
        ...
        var options = {
          ...
          legend: {
            ...
            formatter: function (seriesName, opts) {
              return (
                seriesName + ":  " + arraySegmentacion[opts.seriesIndex] + ""
              );
            },
          },
        };
